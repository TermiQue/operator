...
def _moe_forward_kernel_all64(
    ...
    def kernel(
        ...
        with T.Kernel(
            ...
            gate_weight_barrier = T.alloc_maca_barrier(1)
            up_weight_barrier = T.alloc_maca_barrier(1)
            T.use_swizzle(swizzle_panel)
            ...
            if actual_rows > 0:
                ...
                for k in T.serial(T.ceildiv(hidden, block_dhidden)):
                    ...
                    T.maca_barrier_arrive_and_wait(
                        gate_weight_barrier[0]
                    )
                    T.maca_barrier_arrive_and_wait(
                        up_weight_barrier[0]
                    )
        ...
        with T.Kernel(
            ...
            down_weight_barrier_0 = T.alloc_maca_barrier(1)
            down_weight_barrier_1 = T.alloc_maca_barrier(1)
            ...
            if actual_rows > 0:
                ...
                for k in T.Pipelined(
                    ...
                    T.maca_async_copy(
                        ...
                        down_shared_0,
                        barrier=down_weight_barrier_0[0],
                    )
                    T.maca_async_copy(
                        down_w[
                            expert_id,
                        ...
                        down_shared_1,
                        barrier=down_weight_barrier_1[0],
                    )
                    T.copy(
                        up_logits[
                            block_start : block_start + block_token,
                    ...
                    T.maca_barrier_arrive_and_wait(
                        down_weight_barrier_0[0]
                    )
                    T.maca_barrier_arrive_and_wait(
                        down_weight_barrier_1[0]
                    )
                    T.gemm(
                        up_shared,
                        down_shared_0,
