...
def _moe_forward_kernel_all64(
    ...
    def kernel(
        ...
        with T.Kernel(
            ...
            num_pid_in_group = group_size_m * gate_num_n_packs
            group_id = pid // num_pid_in_group
            first_bx = group_id * group_size_m
            actual_group_size_m = T.min(
                num_m_tiles - first_bx,
                group_size_m,
            )
            pid_in_group = pid % num_pid_in_group
            bx = first_bx + pid_in_group % actual_group_size_m
            by = pid_in_group // actual_group_size_m
            parent_bx = bx // 2
            tile_id = bx % 2
            expert_id = group_idx_for_bx[parent_bx]
        ...
        with T.Kernel(
            ...
            num_pid_in_group = group_size_m * down_num_n_packs
            group_id = pid // num_pid_in_group
            first_bx = group_id * group_size_m
            actual_group_size_m = T.min(
                num_m_tiles - first_bx,
